...
exports.chatWithIntakeAgent = exports.extractLeadData = void 0;
...
const extractLeadData = (conversation) => {
...
const chatWithIntakeAgent = async (messages) => {
...
exports.chatWithIntakeAgent = chatWithIntakeAgent;
